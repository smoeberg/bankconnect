...
final class FailureInjectionQualificationTest extends TestCase
{
    ...
    public function testDuplicateImportFailureInjectionRemainsIdempotent(): void
    {
        ...
        // The qualification gate is about idempotency: both imports must resolve
        // to the same persisted transaction and create exactly one row. Do not
        // couple the gate to MockDoliDB's emulation of MySQL ROW_COUNT().
